...
interface AlterCreateFormProps {
  openAlter: boolean;
  onCreateAlter: (values: Message) => void;
  onCancel: () => void;
  form: FormInstance;
}
// 修改表,执行修改时会弹出
const AlterCreateForm: React.FC<AlterCreateFormProps> = ({
  openAlter,
  onCreateAlter,
  onCancel,
  form,
...
export default AlterCreateForm;
